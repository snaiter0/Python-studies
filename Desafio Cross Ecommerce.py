...
page = 9800                                 #Inicia a variavel Pagina, que será a localização onde o programa irá
    ...
    if (len(espacoAposVirgula) <= 1):           #Confere se o array está vazio
        try:
            if (PaginasSemResposta != 0):
                ...
                print("Tentativa de recuperação das paginas sem respostas:")
                page = EnderecoDasPaginasComErro.pop(PaginasSemResposta-1)
            else:
